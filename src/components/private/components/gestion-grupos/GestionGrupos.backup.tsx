 ...
 * @version 3.0.0
 * @description Componente simplificado para gestión de grupos
 */
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none ${
                          formulario.errors.descripcion ? 'border-red-300' : 'border-gray-300'
                        }`}
                        placeholder="Ej: Grupo con permisos administrativos completos"
                        rows={3}
                        disabled={isCreating || isUpdating}
                        maxLength={200}
                      />
                      {formulario.errors.descripcion && (
                        <p className="mt-1 text-sm text-red-600">{formulario.errors.descripcion}</p>
                      )}
