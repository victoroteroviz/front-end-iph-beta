        ...
        >
          ...
          {images.length > 1 && (
            <>
              ...
              <div
                onClick={() =>
                  currentIndex < images.length - 1 && onNavigate("next")
                }
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">
                  {iphData.nReferencia || "No disponible"}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">
                  {iphData.nFolioSist || "No disponible"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">
                  {iphData.fotos?.length || 0} foto
                  {(iphData.fotos?.length || 0) !== 1 ? "s" : ""}
                </p>
                {iphData.fotos && iphData.fotos.length > 0 && (
                  <button
                  ...
                  <div className="bg-white p-4 rounded border">
                    ...
                    {iphData.hechos.length > 200 && (
                      <p className="text-xs text-gray-500 mt-2 italic">
                        Vista resumida - Ver sección completa en "Narrativa de
                        hechos"
                      </p>
                    )}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-gray-600 bg-gray-50 p-3 rounded border">
              <div>
                ...
                <p className="font-mono">
                  Lat: {iphData.coordenadas.latitud}, Lng:{" "}
                  {iphData.coordenadas.longitud}
                </p>
              </div>
              <div>
