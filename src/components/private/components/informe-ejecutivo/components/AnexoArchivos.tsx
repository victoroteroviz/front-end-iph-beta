...
const getFileIcon = (tipo: string | undefined) => {
  ...
  if (
    ...
    tipoLower.includes("img")
  ) {
    return <FileImage className="h-5 w-5" />;
  }

  if (
    tipoLower.includes("video") ||
    tipoLower.includes("mp4") ||
    tipoLower.includes("mov")
  ) {
  ...
  if (
    ...
    tipoLower.includes("mp3") ||
    tipoLower.includes("wav")
  ) {
...
const getTypeBadgeColor = (tipo: string | undefined) => {
  ...
  if (
    ...
    tipoLower.includes("pdf") ||
    tipoLower.includes("certificado")
  ) {
...
const getFileType = (tipo: string | undefined, archivo?: string): FileType => {
  ...
  if (
    ...
    tipoLower.includes("image") ||
    tipoLower.includes("img") ||
    archivoLower.includes(".jpg") ||
    archivoLower.includes(".jpeg") ||
    archivoLower.includes(".png") ||
    archivoLower.includes(".gif") ||
    archivoLower.includes(".webp")
  ) {
    return "image";
  }
  ...
  if (
    ...
    tipoLower.includes("mp4") ||
    tipoLower.includes("mov") ||
    archivoLower.includes(".mp4") ||
    archivoLower.includes(".mov") ||
    archivoLower.includes(".avi") ||
    archivoLower.includes(".webm")
  ) {
    return "video";
  }
  ...
  if (
    ...
    tipoLower.includes("mp3") ||
    tipoLower.includes("wav") ||
    archivoLower.includes(".mp3") ||
    archivoLower.includes(".wav") ||
    archivoLower.includes(".ogg") ||
    archivoLower.includes(".m4a")
  ) {
    return "audio";
  }
...
const PDFThumbnail: React.FC<PDFThumbnailProps> = memo(
  ({ url, className = "", fallback, height = 160 }) => {
...
const FilePreview: React.FC<FilePreviewProps> = memo(
  ({ archivo, className = "", viewContext = "grid" }) => {
    ...
    switch (fileType) {
            ...
            {!videoError && fullPath && isVisible ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-700 to-gray-800">
                ...
                <span className="text-xs text-gray-300 font-medium">
                  {!isVisible ? "Cargando..." : "No disponible"}
                </span>
              </div>
            )}
            <div className="absolute inset-0 bg-black bg-opacity-10 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
      ...
      case "audio":
        return (
          <div
            className={`relative w-full h-full bg-green-100 rounded-lg flex flex-col items-center justify-center ${className}`}
          >
      ...
      default: {
        ...
        return (
          <div
            className={`relative w-full h-full bg-gray-100 rounded-lg flex flex-col items-center justify-center ${className}`}
          >
            ...
            <div className="text-center w-full">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
                ...
                <div className="mt-4 flex items-center justify-center gap-2 text-sm text-gray-600">
                  ...
                  <p>
                    Usa los controles para reproducir, pausar y ajustar el
                    volumen
                  </p>
                </div>
              </div>
        ...
        <div className="flex-shrink-0 p-6 border-b bg-white rounded-t-lg">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              <div className="mt-3">
                <span
                  className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${getTypeBadgeColor(archivo.tipo)}`}
                >
...
const AnexoArchivos: React.FC<AnexoArchivosProps> = memo(
  ({ archivos, className = "" }) => {
    ...
    const filteredArchivos = useMemo(() => {
      ...
      return archivosArray.filter(
        (archivo) => getFileType(archivo.tipo, archivo.archivo) === filterType,
      );
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  ...
                  {typeCounts.image > 0 && (
                    <option value="image">Imágenes ({typeCounts.image})</option>
                  )}
                  {typeCounts.audio > 0 && (
                    <option value="audio">Audios ({typeCounts.audio})</option>
                  )}
            ...
            <>
              ...
              <div className="bg-white rounded-lg p-4 mb-6">
                ...
                <p className="text-sm text-gray-600 font-poppins">
                  Haz clic en cualquier archivo para ver su preview en pantalla
                  completa.
                </p>
              </div>
                          ...
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-3 flex-1 min-w-0">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {archivo.tipo && (
                                  <span
                                    className={`inline-block px-2 py-1 rounded-full text-xs font-medium mt-1 ${getTypeBadgeColor(archivo.tipo)}`}
                                  >
                                    {archivo.tipo}
                                  </span>
                                )}
                  ...
                  {filteredArchivos.map((archivo, index) => (
                    ...
                    >
                      ...
                      <div className="p-3">
                        ...
                        {archivo.tipo && (
                          <span
                            className={`inline-block px-2 py-1 rounded-full text-xs font-medium mb-2 ${getTypeBadgeColor(archivo.tipo)}`}
                          >
                            {archivo.tipo}
                          </span>
                        )}
