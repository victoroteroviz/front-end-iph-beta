  ...
  return (
    <div className={`flex flex-col sm:flex-row gap-3 ${className}`}>
      ...
      <button
        type="button"
        onClick={onCancel}
        className="flex items-center justify-center px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300 transition-colors font-medium font-poppins"
      ...
      <button
        ...
        className={`
          ...
          ${canSubmit && !isSubmitting
            ? 'bg-[#948b54] hover:bg-[#7d7548] shadow-md hover:shadow-lg transform hover:-translate-y-0.5'
