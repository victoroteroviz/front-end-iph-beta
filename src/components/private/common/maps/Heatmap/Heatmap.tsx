    ...
    <div className={`bg-white rounded-lg shadow-md p-6 ${className}`}>
          ...
          <div className="bg-gradient-to-r from-[#f8fafc] to-[#f1f5f9] border border-[#cbd5e1] rounded-lg p-3">
            <div className="flex items-center gap-3">
              <div className="flex-shrink-0">
                <svg className="w-5 h-5 text-[#1a2744]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-[#1a2744] mb-1">Centro del mapa:</p>
                {centerAddressLoading ? (
            ...
            {loading && coordenadas.length === 0 ? (
              ...
              <div className="w-full h-full bg-gray-200 animate-pulse flex items-center justify-center">
                <div className="text-center">
                  <svg className="animate-spin h-8 w-8 text-[#1a2744] mx-auto mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                  </svg>
                  <p className="text-[#1a2744] font-medium">Cargando mapa...</p>
                </div>
              </div>
            ) : (
            <MapContainer
            ...
            >
              ...
              {circlePropsMap.map(({ lat, lng, count, originalIndex, circleProps }) => (
                ...
                >
                  <Popup>
                    <div className="text-center">
                      <h4 className="font-semibold text-[#1a2744] mb-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-[#f8f9fa] rounded-lg p-4">
          <h4 className="text-lg font-semibold text-[#1a2744] mb-4">Estadísticas</h4>
          <div className="grid grid-cols-2 gap-3">
            <div className="text-center">
              <div className="text-xl font-bold text-[#1a2744]">{stats.totalIPH}</div>
        ...
        <div className="bg-gradient-to-br from-[#f9fafb] to-[#f3f4f6] p-4 rounded-lg border border-[#e5e7eb]">
          <h5 className="font-semibold text-[#1a2744] mb-3 flex items-center gap-2">
