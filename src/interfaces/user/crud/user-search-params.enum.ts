...
export type UserSearchParams = typeof UserSearchParams[keyof typeof UserSearchParams];

/**
 * Parámetros de ordenamiento de usuarios
...
export type UserOrderByParams = typeof UserOrderByParams[keyof typeof UserOrderByParams];
 ...
 */
export type UserSearchBy = UserSearchParams;

/**
 * Type helper para los valores válidos de ordenamiento
 */
export type UserOrderBy = UserOrderByParams;